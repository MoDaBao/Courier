...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame])
    {
        ...
        _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(RouteCellLeftMargin + RouteCellLeftMargin + CGRectGetWidth(_prevImageView.frame), RouteCellTopMargin, labelWidth, 38)];
