//
//  DeliveryDefaultTableViewCell.m
//  peisongduan
//
...
@interface DeliveryDefaultTableViewCell ()<UIAlertViewDelegate>
...
@implementation DeliveryDefaultTableViewCell
...
- (void)pickbtn {
    ...
    self.pickBtn.userInteractionEnabled = NO;
