...
@implementation OrderDefaultView
...
- (void)awakeFromNib {
    ...
    self.frame = CGRectMake(0, kNavigationBarHeight, kScreenWidth, 96);
    float sortaPixel =1.0/[UIScreen mainScreen].scale;
    UIView *line = [[UIView alloc]initWithFrame:CGRectMake(0,96 - sortaPixel,kScreenWidth, sortaPixel)];
