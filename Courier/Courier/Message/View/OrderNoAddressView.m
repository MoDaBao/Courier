...
@implementation OrderNoAddressView
...
- (void)awakeFromNib {
    self.frame = CGRectMake(0, kNavigationBarHeight, kScreenWidth, 59);
    
    float sortaPixel =1.0/[UIScreen mainScreen].scale;
    UIView *line = [[UIView alloc]initWithFrame:CGRectMake(0,59 - sortaPixel,kScreenWidth, sortaPixel)];
